...
public class MemoService {
    ...
    public Long createMemo(MemoDto dto, Long userId) {
        ...
        memo.setTitle(dto.getTitle() != null ? dto.getTitle() : "제목 없음");
        memo.setContent(dto.getContent());
        memo.setSortOrder(dto.getSortOrder() != null ? dto.getSortOrder() : 0);
    ...
    public void updateMemo(Long id, MemoDto dto, Long userId) {
        ...
        memo.setTitle(dto.getTitle() != null ? dto.getTitle() : memo.getTitle());
        memo.setContent(dto.getContent());
        if (dto.getSortOrder() != null) {
            memo.setSortOrder(dto.getSortOrder());
        }
