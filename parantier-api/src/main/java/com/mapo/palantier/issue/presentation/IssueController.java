...
public class IssueController {
    ...
    public IssueController(
        ...
        IssueAssigneeMapper issueAssigneeMapper,
    ...
    public ResponseEntity<IssueResponse> createIssue(
        ...
        issue.setPriority(
            request.getPriority() != null
                ? request.getPriority()
                : com.mapo.palantier.issue.domain.IssuePriority.MEDIUM
        );
    ...
    public ResponseEntity<List<IssueImage>> getIssueImages(
    ...
    public ResponseEntity<List<IssueAssignee>> getIssueAssignees(
        @PathVariable Long issueId
    ) {
        List<IssueAssignee> assignees = issueAssigneeMapper.findByIssueId(
            issueId
        );
    ...
    public ResponseEntity<List<IssueChecklist>> getChecklists(
        @PathVariable Long issueId
    ) {
        List<IssueChecklist> checklists = issueChecklistMapper.findByIssueId(
            issueId
        );
    ...
    public ResponseEntity<List<IssueMindmap>> getMindmaps(
        @PathVariable Long issueId
    ) {
    ...
    public ResponseEntity<List<Map<String, Object>>> getLinkedTasks(
        @PathVariable Long issueId
    ) {
        List<Map<String, Object>> tasks =
            issueTaskLinkMapper.findTasksByIssueId(issueId);
    ...
    public ResponseEntity<List<IssueDbTable>> getDbTables(
        @PathVariable Long issueId
    ) {
