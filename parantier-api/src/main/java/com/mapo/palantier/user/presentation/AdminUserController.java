...
public class AdminUserController {
    ...
    @Operation(
        summary = "사용자 조직 일괄 변경",
        description = "관리자가 여러 사용자의 조직을 일괄 변경합니다."
    )
    ...
    @Operation(
        summary = "사용자 조직에서 제거",
        description = "관리자가 사용자를 조직에서 제거합니다 (미소속 상태로 변경)."
    )
    ...
    @Operation(
        ...
        description = "특정 사용자의 권한 목록을 조회합니다."
    )
    ...
    public ResponseEntity<List<UserAuthorityResponse>> getUserAuthorities(
        ...
        List<UserAuthorityResponse> authorities =
            userAuthorityService.getUserAuthorities(userId);
        return ResponseEntity.ok(authorities);
    }

    @Operation(
        summary = "전체 권한 목록 조회",
        description = "권한 할당에 사용할 전체 권한 목록을 조회합니다."
    )
    ...
    @Operation(
        summary = "사용자 일괄 삭제",
        description = "관리자가 선택한 사용자들을 삭제합니다."
    )
    @DeleteMapping("/bulk")
    ...
    @Operation(
        summary = "사용자 권한 일괄 업데이트",
        description = "사용자의 권한을 일괄적으로 업데이트합니다."
    )
    ...
    public ResponseEntity<Void> updateUserAuthorities(
        ...
        userAuthorityService.updateUserAuthorities(
            userId,
