...
export interface SubutaiDocuFolder {
  id: number;
...
export interface SubutaiDocuBlock {
  id?: number;
  postId?: number;
  blockType: BlockType;
  content: string;
...
export interface SubutaiDocuPost {
  id: number;
  folderId: number;
  title: string;
  authorId: number;
...
export interface SubutaiDocuComment {
  id: number;
  postId: number;
  authorId: number;
  authorName: string;
...
// DTO types
export interface SubutaiDocuFolderDto {
  id?: number;
  parentId: number | null;
  name: string;
  sortOrder?: number;
...
export interface SubutaiDocuPostDto {
  id?: number;
  folderId: number;
  title: string;
  blocks: SubutaiDocuBlockDto[];
}

export interface SubutaiDocuCommentDto {
  postId: number;
  content: string;
}
