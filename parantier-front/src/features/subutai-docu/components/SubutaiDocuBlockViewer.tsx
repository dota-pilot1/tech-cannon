import type { SubutaiDocuPost } from "../types/subutaiDocu.types";
import {
  TYPE_META,
  parseFileContent,
  parseDbTableContent,
...
export default function SubutaiDocuBlockViewer({ post }: Props) {
  const thStyle =
        ...
        {!post.blocks || post.blocks.length === 0 ? (
          ...
          post.blocks.map((block, idx) => {
            ...
            return (
              <div
                key={idx}
                className="border rounded shadow-sm overflow-hidden mb-4"
              >
                  ...
                  (() => {
                    ...
                    return (
                      <div className="p-4 bg-white space-y-3">
                        ...
                        {file.description && (
                          <p className="text-sm text-gray-600 whitespace-pre-wrap px-1">
                            {file.description}
                          </p>
                        )}
                      </div>
                                ...
                                <thead className="bg-gray-700 text-white">
                                  <tr>
                                    {tbl.headers.map((header, idx) => (
                                      <th
                                        key={idx}
                                        className="border border-gray-600 px-3 py-2 text-left text-xs font-normal"
                                      >
                                        {header}
                                      </th>
                                    ))}
                              ...
                              <tbody>
                                {tbl.columns.map((col, ci) => (
                                  ...
                                  >
                                    ...
                                    <td className="border border-gray-200 px-3 py-1.5 font-mono text-blue-700">
                                      {col.type}
                                    </td>
                                    ...
                                    <td className="border border-gray-200 px-3 py-1.5 text-gray-500 text-[11px]">
                                      {col.note}
                                    </td>
                                  </tr>
                                ))}
