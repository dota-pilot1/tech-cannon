...
import { useTopicComments, useCreateTopicComment, useDeleteTopicComment } from '../hooks/useTopic'
...
export function TopicCommentList({ topicId }: TopicCommentListProps) {
  const [commentText, setCommentText] = useState('')
  const { data: comments = [] } = useTopicComments(topicId)
  const createComment = useCreateTopicComment(topicId)
  const deleteComment = useDeleteTopicComment(topicId)
